...
public class SystemManager {
	...
	private void initialize() {
		...
		JLabel label = new JLabel("\u6B22\u8FCE\u7CFB\u7EDF\u7BA1\u7406\u5458");
		label.setForeground(Color.RED);
		label.setFont(new Font("楷体", Font.PLAIN, 25));
		label.setBounds(331, 114, 210, 50);
		frame.getContentPane().add(label);
		
		JButton btnNewButton = new JButton("\u589E\u52A0\u7BA1\u7406\u5458");
		...
		btnNewButton.setBounds(351, 211, 141, 23);
		frame.getContentPane().add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("\u5220\u9664\u7BA1\u7406\u5458");
		...
		btnNewButton_1.setBounds(351, 258, 141, 23);
		frame.getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("\u67E5\u8BE2\u7BA1\u7406\u5458");
		...
		btnNewButton_2.setBounds(351, 309, 141, 23);
		frame.getContentPane().add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("\u4FEE\u6539\u7BA1\u7406\u5458");
		...
		btnNewButton_3.setBounds(351, 356, 141, 23);
